...
export default function Cart({ pok }) {

    // console.log("card unique", pok);
    return (
        <div>
            {pok &&
                <div className="card border border-3 border-warning" style={{ width: "9rem", height: "13rem", backgroundColor: pok.background_color }}>
                    <div className='p-2'>
                        {/* upp part of cards  */}
